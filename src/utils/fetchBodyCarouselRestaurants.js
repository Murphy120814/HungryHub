const CAROUSEL_URL = (
  ...
  `http://HHServerProxy.us-east-1.elasticbeanstalk.com/api/swiggy/dapi/restaurants/list/v5?lat=${lat}&lng=${lng}&${id}&sortBy=&filters=&type=rcv2&offset=0&page_type=null`;
