const SUGGESTED_DISHES_RESTAURANT_FETCH_URL = (
  ...
  `https://hungryhubapi.frontendmeta.dev/api/swiggy/dapi/restaurants/search/v3?lat=${lat}&lng=${lng}&str=${nameOfDish}&trackingId=undefined&submitAction=SUGGESTION&metaData=${metaData}`;
