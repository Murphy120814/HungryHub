const SUGGESTED_DISHES_RESTAURANT_FETCH_URL = (
  ...
  `https://thingproxy.freeboard.io/fetch/https://www.swiggy.com/dapi/restaurants/search/v3?lat=${lat}&lng=${lng}&str=${nameOfDish}&trackingId=undefined&submitAction=SUGGESTION&metaData=${metaData}`;
