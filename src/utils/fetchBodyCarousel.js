export const FETCH_URL = (lat = "18.9894007", lng = "73.1175162") =>
  `https://HHServerProxy.us-east-1.elasticbeanstalk.com/api/swiggy/dapi/restaurants/list/v5?lat=${lat}&lng=${lng}&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING`;
