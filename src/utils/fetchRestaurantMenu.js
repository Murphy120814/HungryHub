const MENU_URL = (id, lat = "18.9894007", lng = "73.1175162") =>
  `https://hhapi.frontendmeta.dev/api/swiggy/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=${lat}&lng=${lng}&restaurantId=${id}&catalog_qa=undefined&submitAction=ENTER`;
